Numpy by.Playdata (2022/11/23 ~ 2022/11/28)
====================
# Numpy란?
...
- **np.random**
    - 지정한 숫자 순서대로 왼쪽 위부터 오른쪽 아래까지 대각선을 이루면서 배열 생성
        ...
        # 224page 넘피의 난수
        a = np.random.rand(3, 5)    #rand(행, 열) 3행 5열 양 실수 0.00000 ~ 0.9999
        # 출력
        #[[0.6854246  0.33921641 0.69679183 0.63701332 0.13366292]
        # [0.23241699 0.7144475  0.2821887  0.74630316 0.24941706]
        # [0.48124339 0.12489575 0.65602673 0.97011624 0.93223052]]
        
        b = np.random.randn(3, 5)   #randn(세트, 행, 열) 3행 5열 음양 실수
        # 출력
        #[[ 0.86608536  0.75519355  1.32716646  1.03180279 -0.15640953]
        # [-0.99812031  0.08560812 -0.09010871 -0.60589924 -1.70103963]
        # [ 1.20026443 -0.61085417 -1.05799583  0.36741829  0.55166912]]
        
        c = np.random.randint(3, 5) #randint(시작 값, 끝값) 3 ~ 5 사이의 숫자 하나만 발생
        # 출력
        # 3
        
        # np.random.randint는 파이썬 모듈 random.randint와 역할이 동일
        ```
...
- **np.dot**
    - 행렬 곱
        ...
        print(a)
        print()
        result = np.dot(a, a) # 지정한 두 배열들의 행렬곱을 실행함.
        print(result)
        
        # 출력
        #[[33 32] # 이중 배열에서 a[0][0] * a[0][1] + a[0][0] * a[1][0]
        # [16 17]] # 이런 식으로 각각 행이랑 열이 증가하면서 곱함
        ```
...
- **np.det**
    - 행렬식
        ...
        a = np.array([[1, 2], [3, 4]])
        print(np.linalg.dev(a)) 
        print()
        
        # 출력  [a, b] [c, d]로 가정 시 ad - bc
        # -2.0000000000000004
        ```
...
- **np.trace**
    - 배열의 대각선 합
        ...
        # trace => 배열의 대각선인 0, 5, 10, 15를 더한 값
        # 30
        ```
